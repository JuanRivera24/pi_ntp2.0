...
import sys
import os
import locale # <--- 1. IMPORTAMOS LA LIBRERÍA LOCALE

# --- 2. ESTABLECEMOS EL IDIOMA A ESPAÑOL PARA LAS FECHAS ---
try:
...
with col_graf4:
    ...
    if not df_citas_reales.empty:
        ...
        df_citas_reales.loc[:, 'Fecha_dt'] = pd.to_datetime(df_citas_reales['Fecha'])
